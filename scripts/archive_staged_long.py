...
def main():
    ...
    artifacts=set((OUT/'main').rglob('*.json'))|set((OUT/'main').rglob('*.pt'))
    ...
    for seed in [71,72,73]:
        ...
        artifacts.update([old/'measurements.json',old/'validation-262144.json'])
        artifacts.add(ROOT/f'results/plasticity/staged/main/evaluation/staged_262k-{seed}.json')
    artifacts.update(OUT/name for name in ['comparison.json','result-table.md','comparison.png','comparison.pdf','failure-types.png','main.log','tests.log'])

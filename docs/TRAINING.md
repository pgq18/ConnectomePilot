...
所有命令从仓库根目录执行。先按[首页](../README.md)创建项目 Conda 环境；每次新开终端先激活：
...
python scripts/prepare_plasticity.py
```
...
python scripts/summarize_staged_4m.py
python scripts/plot_staged_4m.py
python scripts/report_staged_4m.py
```
